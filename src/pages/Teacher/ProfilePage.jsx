/**
 * ProfilePage.jsx — Teacher Dashboard · Profile Module
 * Teacher-specific profile view: same shell as Admin but with
 * teacher-relevant fields (subject, grade level, section, adviser flag).
 */

import { useState, useCallback } from "react";
import { Navigate } from "react-router-dom";
import Sidebar from "../../Components/Sidebar";
import { useTeacherProfile } from "../../hooks/teacher/useProfile";
...
function ChangePasswordModal({ onClose, onSuccess }) {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await teacherProfileService.changePassword({
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-box" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-footer">
          ...
          <button
            className={`btn btn--save${loading ? " btn--loading" : ""}`}
...
// ── Adviser Badge ──────────────────────────────────────────────
function AdviserBadge({ isAdviser }) {
...
function ProfilePageComponent() {
  ...
  // Role-based access: only teachers can access this page
  if (!auth?.isAuthenticated || auth.role !== "Teacher") {
        ...
        <main className="profile-main">
          <div className="profile-header">
            <div>
              ...
              <p className="profile-sub">View and manage your teacher account information.</p>
            </div>
          </div>
      ...
      <main className="profile-main">
        ...
        <div className="profile-card">
            ...
            <div className="profile-name-row">
              <div>
                ...
                <div className="profile-meta">
                  ...
                  <AdviserBadge isAdviser={form.isAdviser} />
                </div>
              </div>
              ...
              <div className="profile-actions">
                {!editing ? (
                  ...
                  <>
                    ...
                    <button
                      className={`btn btn--save${saving ? " btn--loading" : ""}`}
                      onClick={onSave}
                      disabled={saving}
                    >
                      {saving ? (
          ...
          <div className="profile-form">
            ...
            {/* Teaching Information — teacher-specific section */}
            <section className="form-section">
              ...
              <div className="form-grid">
                ...
                <FieldRow label="Department"   value={form.department}   editing={editing} onChange={() => {}} readOnly />
                <FieldRow label="Subject(s)"   value={form.subjects}     editing={editing} onChange={() => {}} readOnly />
                <FieldRow label="Grade Level"  value={form.gradeLevel}   editing={editing} onChange={() => {}} readOnly />
                {/* Advisory section — only shown when teacher is a class adviser */}
                {form.isAdviser && (
                  <FieldRow label="Advisory Section" value={form.advisorySection} editing={editing} onChange={() => {}} readOnly />
                )}
              </div>
            </section>
