    ...
    <div className="field">
      ...
      {editing && !readOnly ? (
        <input
          ...
          placeholder={type === "email" ? "name@deped.gov.ph" : `Enter ${label.toLowerCase()}`}
    ...
    <div className="field">
      ...
      <div className="pw-wrap">
        <input
          ...
          placeholder={label.toLowerCase().includes("confirm") ? "Re-enter password" : "Enter password"}
          value={value}
          onChange={(e) => onChange(e.target.value)}
...
function ChangePasswordModal({ onClose, onSuccess }) {
  ...
  const validate = () => {
    ...
    e.newPw = validatePasswordStrength(form.newPw, "New password");
