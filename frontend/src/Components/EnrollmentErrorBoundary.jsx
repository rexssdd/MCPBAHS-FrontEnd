/**
 * EnrollmentErrorBoundary.jsx
 * Error boundary for Enrollment component with graceful recovery
 */
...
class EnrollmentErrorBoundary extends Component {
  ...
  componentDidCatch(error, errorInfo) {
    console.error("Enrollment Error Boundary caught:", error, errorInfo);
    this.setState({
      error,
      errorInfo,
    });
          ...
          <main className="page-main">
            <div className="page-body">
              <div className="error-boundary-container" style={{ padding: "40px 20px", textAlign: "center" }}>
                <h1 style={{ color: "#C62828", marginBottom: "16px" }}>⚠️ Enrollment Error</h1>
                <p style={{ color: "#666", marginBottom: "20px", fontSize: "14px" }}>
                  Something went wrong loading the enrollment page. Please try again.
                </p>
                {import.meta.env.DEV && (
